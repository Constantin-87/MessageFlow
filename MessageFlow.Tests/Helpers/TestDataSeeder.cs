...
namespace MessageFlow.Tests.Helpers
{
    public static class TestDataSeeder
    {
        ...
        public static void ConfigureInMemoryDb<TContext>(
            ...
            RoleManager<IdentityRole> roleManager)
        {
            ...
            foreach (var teamDTO in teams)
            {
                ...
                await unitOfWork.Teams.AddEntityAsync(teamEntity);
            }
            await unitOfWork.SaveChangesAsync();
            ...
            var usersToSeed = new List<(ApplicationUser User, string Password, string Role)>
            {
                ...
                (new ApplicationUser { Id = "4", UserName = "manager@companya.com", Email = "manager@companya.com", CompanyId = "2" }, "Manager@123", "AgentManager"),
            ...
            await unitOfWork.ProcessedPretrainData.AddProcessedFilesAsync(new List<ProcessedPretrainData> { file });
            await unitOfWork.SaveChangesAsync();
        }
    }
}