...
namespace MessageFlow.Tests.Tests.Server.MediatR.Chat.AIBotProcessing.Commands
{
    public class HandleUserQueryHandlerTests
    {
        ...
        public void BuildSystemPromptNoResults_FormatsFallbackTeamsCorrectly()
        {
            ...
            var method = typeof(HandleUserQueryHandler)
                .GetMethod("BuildSystemPromptNoResults", BindingFlags.NonPublic | BindingFlags.Static)!;

            string history = "No previous chat";

            var prompt = (string)method.Invoke(null, new object[] { history, fallbackTeams })!;
