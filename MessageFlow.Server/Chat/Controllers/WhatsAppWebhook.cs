...
using MessageFlow.Server.Chat.Helpers;
...
public class WhatsAppWebhook : ControllerBase
{
    ...
    public WhatsAppWebhook(ILogger<WhatsAppService> logger, IWhatsAppService whatsAppService, IOptions<GlobalChannelSettings> globalChannelSettings)
    {
        _logger = logger;
