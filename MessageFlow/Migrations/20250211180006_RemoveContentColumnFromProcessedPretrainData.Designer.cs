...
namespace MessageFlow.Server.Migrations
{
    ...
    [Migration("20250211180006_RemoveContentColumnFromProcessedPretrainData")]
    partial class RemoveContentColumnFromProcessedPretrainData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MessageFlow.Server.Models.ArchivedConversation", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MessageFlow.Server.Models.ArchivedMessage", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MessageFlow.Server.Models.CompanyEmail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MessageFlow.Server.Models.CompanyPhoneNumber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MessageFlow.Server.Models.Conversation", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MessageFlow.Server.Models.Message", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MessageFlow.Server.Models.PhoneNumberInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MessageFlow.Server.Models.PretrainDataFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MessageFlow.Server.Models.ProcessedPretrainData", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MessageFlow.Server.Models.WhatsAppSettingsModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MessageFlow.Server.Models.ArchivedMessage", b =>
                {
                    b.HasOne("MessageFlow.Server.Models.ArchivedConversation", "ArchivedConversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("MessageFlow.Server.Models.Message", b =>
                {
                    b.HasOne("MessageFlow.Server.Models.Conversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("MessageFlow.Server.Models.PhoneNumberInfo", b =>
                {
                    b.HasOne("MessageFlow.Server.Models.WhatsAppSettingsModel", null)
